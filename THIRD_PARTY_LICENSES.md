...
- **Game mechanics and rules** — character generation tables, ability
  modifiers, class stat ranges, equipment lists, and scroll mechanics.
  These are freely reusable under the license.
- **Names of classes, creatures, locations and entities** — permitted
  by the license.
- **Official character sheet PDF** — the fillable AcroForm template
  distributed freely at <https://morkborg.com/license/> is used as-is
  for PDF export. No modifications are made to the template artwork or
  layout.

### What this project does NOT redistribute

- Art, illustrations, or graphic design from any MÖRK BORG publication.
- The MÖRK BORG logo or any Stockholm Kartell / Ockult Örtmästare
  Games branding.
